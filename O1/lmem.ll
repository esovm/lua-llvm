...
; <label>:20:                                     ; preds = %13, %16
  ...
  %27 = tail call i8* @luaM_realloc_(%struct.lua_State* %0, i8* %1, i64 %24, i64 %26)
...
; <label>:11:                                     ; preds = %4
  ...
  %16 = tail call i8* %13(i8* %15, i8* %1, i64 %2, i64 %3) #5
  br label %17
...
define hidden i8* @luaM_saferealloc_(%struct.lua_State*, i8*, i64, i64) local_unnamed_addr #0 {
  %5 = tail call i8* @luaM_realloc_(%struct.lua_State* %0, i8* %1, i64 %2, i64 %3)
  %6 = icmp eq i8* %5, null
  %7 = icmp ne i64 %3, 0
  %8 = and i1 %7, %6
