...
; <label>:6:                                      ; preds = %1
  ...
  %8 = tail call fastcc i8* @searchpath(%struct.lua_State* %0, i8* %2, i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.19, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.20, i64 0, i64 0)) #6
  br label %11

; <label>:9:                                      ; preds = %1
  %10 = tail call fastcc i8* @searchpath(%struct.lua_State* %0, i8* %2, i8* nonnull %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.19, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.20, i64 0, i64 0)) #6
  br label %11
...
; <label>:14:                                     ; preds = %11
  %15 = tail call i32 @luaL_loadfilex(%struct.lua_State* %0, i8* nonnull %12, i8* null) #6
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %17, label %19

; <label>:17:                                     ; preds = %14
  %18 = tail call i8* @lua_pushstring(%struct.lua_State* %0, i8* nonnull %12) #6
  br label %23

; <label>:19:                                     ; preds = %14
  %20 = tail call i8* @lua_tolstring(%struct.lua_State* %0, i32 1, i64* null) #6
  %21 = tail call i8* @lua_tolstring(%struct.lua_State* %0, i32 -1, i64* null) #6
  %22 = tail call i32 (%struct.lua_State*, i8*, ...) @luaL_error(%struct.lua_State* %0, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.30, i64 0, i64 0), i8* %20, i8* nonnull %12, i8* %21) #6
  br label %23

; <label>:23:                                     ; preds = %19, %17, %11
  %24 = phi i32 [ 1, %11 ], [ 2, %17 ], [ %22, %19 ]
  ret i32 %24
}
...
; <label>:14:                                     ; preds = %11
  %15 = tail call fastcc i32 @loadfunc(%struct.lua_State* %0, i8* nonnull %12, i8* %2)
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %17, label %19
...
; <label>:14:                                     ; preds = %5
  ...
  %16 = tail call fastcc i8* @searchpath(%struct.lua_State* %0, i8* %10, i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.19, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.20, i64 0, i64 0)) #6
  br label %19

; <label>:17:                                     ; preds = %5
  %18 = tail call fastcc i8* @searchpath(%struct.lua_State* %0, i8* %10, i8* nonnull %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.19, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.20, i64 0, i64 0)) #6
  br label %19

; <label>:19:                                     ; preds = %14, %17
  %20 = phi i8* [ %18, %17 ], [ %16, %14 ]
  %21 = icmp eq i8* %20, null
  br i1 %21, label %32, label %22

; <label>:22:                                     ; preds = %19
  %23 = tail call fastcc i32 @loadfunc(%struct.lua_State* %0, i8* nonnull %20, i8* %2)
...
; <label>:24:                                     ; preds = %22
  %25 = tail call i8* @lua_tolstring(%struct.lua_State* %0, i32 1, i64* null) #6
  %26 = tail call i8* @lua_tolstring(%struct.lua_State* %0, i32 -1, i64* null) #6
  %27 = tail call i32 (%struct.lua_State*, i8*, ...) @luaL_error(%struct.lua_State* %0, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.30, i64 0, i64 0), i8* %25, i8* nonnull %20, i8* %26) #6
  br label %32

; <label>:28:                                     ; preds = %22
  %29 = tail call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.34, i64 0, i64 0), i8* %2, i8* nonnull %20) #6
  br label %32

; <label>:30:                                     ; preds = %22
  %31 = tail call i8* @lua_pushstring(%struct.lua_State* %0, i8* nonnull %20) #6
  br label %32

; <label>:32:                                     ; preds = %19, %1, %30, %28, %24
  %33 = phi i32 [ %27, %24 ], [ 1, %28 ], [ 2, %30 ], [ 0, %1 ], [ 1, %19 ]
  ret i32 %33
}
