...
; <label>:6:                                      ; preds = %2
  ...
  %10 = load %struct.CallInfo*, %struct.CallInfo** %9, align 8, !tbaa !27
  %11 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 7
  %12 = load i16, i16* %11, align 2, !tbaa !40
  %13 = and i16 %12, 8
  %14 = icmp eq i16 %13, 0
...
; <label>:15:                                     ; preds = %6
  %16 = and i16 %12, -9
  store i16 %16, i16* %11, align 2, !tbaa !40
  %17 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 4, i32 0, i32 1
  %18 = load i64, i64* %17, align 8, !tbaa !15
  %19 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 18
  store i64 %18, i64* %19, align 8, !tbaa !63
  br label %20

; <label>:20:                                     ; preds = %15, %6
  %21 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 6
  %22 = load i16, i16* %21, align 4, !tbaa !55
  %23 = icmp slt i16 %22, 0
  br i1 %23, label %24, label %31

; <label>:24:                                     ; preds = %20
  %25 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 1
  %26 = load %union.StackValue*, %union.StackValue** %25, align 8, !tbaa !28
  %27 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6
  %28 = load %union.StackValue*, %union.StackValue** %27, align 8, !tbaa !18
  %29 = icmp ult %union.StackValue* %26, %28
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %24
  store %union.StackValue* %28, %union.StackValue** %25, align 8, !tbaa !28
  br label %31

; <label>:31:                                     ; preds = %20, %24, %30
  %32 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 4, i32 0, i32 0
  %33 = load i32 (%struct.lua_State*, i32, i64)*, i32 (%struct.lua_State*, i32, i64)** %32, align 8, !tbaa !15
  %34 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %10, i64 0, i32 4, i32 0, i32 2
  %35 = load i64, i64* %34, align 8, !tbaa !15
  %36 = tail call i32 %33(%struct.lua_State* nonnull %0, i32 %8, i64 %35) #9
  tail call void @luaD_poscall(%struct.lua_State* nonnull %0, %struct.CallInfo* nonnull %10, i32 %36) #9
  br label %37

; <label>:37:                                     ; preds = %4, %31
  %38 = phi %struct.CallInfo** [ %5, %4 ], [ %9, %31 ]
  %39 = load %struct.CallInfo*, %struct.CallInfo** %38, align 8, !tbaa !27
  %40 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 16
  %41 = icmp eq %struct.CallInfo* %39, %40
  br i1 %41, label %78, label %42

; <label>:42:                                     ; preds = %37
  %43 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 18
  %44 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6
  br label %45

; <label>:45:                                     ; preds = %42, %75
  %46 = phi %struct.CallInfo* [ %39, %42 ], [ %76, %75 ]
  %47 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 7
  %48 = load i16, i16* %47, align 2, !tbaa !40
  %49 = and i16 %48, 2
  %50 = icmp eq i16 %49, 0
...
; <label>:54:                                     ; preds = %51
  %55 = and i16 %48, -9
  store i16 %55, i16* %47, align 2, !tbaa !40
  %56 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 4, i32 0, i32 1
  %57 = load i64, i64* %56, align 8, !tbaa !15
  store i64 %57, i64* %43, align 8, !tbaa !63
  br label %58

; <label>:58:                                     ; preds = %54, %51
  %59 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 6
  %60 = load i16, i16* %59, align 4, !tbaa !55
  %61 = icmp slt i16 %60, 0
  br i1 %61, label %62, label %68

; <label>:62:                                     ; preds = %58
  %63 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 1
  %64 = load %union.StackValue*, %union.StackValue** %63, align 8, !tbaa !28
  %65 = load %union.StackValue*, %union.StackValue** %44, align 8, !tbaa !18
  %66 = icmp ult %union.StackValue* %64, %65
  br i1 %66, label %67, label %68

; <label>:67:                                     ; preds = %62
  store %union.StackValue* %65, %union.StackValue** %63, align 8, !tbaa !28
  br label %68

; <label>:68:                                     ; preds = %58, %62, %67
  %69 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 4, i32 0, i32 0
  %70 = load i32 (%struct.lua_State*, i32, i64)*, i32 (%struct.lua_State*, i32, i64)** %69, align 8, !tbaa !15
  %71 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %46, i64 0, i32 4, i32 0, i32 2
  %72 = load i64, i64* %71, align 8, !tbaa !15
  %73 = tail call i32 %70(%struct.lua_State* nonnull %0, i32 1, i64 %72) #9
  tail call void @luaD_poscall(%struct.lua_State* nonnull %0, %struct.CallInfo* nonnull %46, i32 %73) #9
  br label %75

; <label>:74:                                     ; preds = %45
  tail call void @luaV_finishOp(%struct.lua_State* nonnull %0) #9
  tail call void @luaV_execute(%struct.lua_State* nonnull %0, %struct.CallInfo* nonnull %46) #9
  br label %75

; <label>:75:                                     ; preds = %74, %68
  %76 = load %struct.CallInfo*, %struct.CallInfo** %38, align 8, !tbaa !27
  %77 = icmp eq %struct.CallInfo* %76, %40
  br i1 %77, label %78, label %45

; <label>:78:                                     ; preds = %75, %37
  ret void
}
...
attributes #5 = { nounwind returns_twice "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
...
attributes #8 = { nounwind readonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
