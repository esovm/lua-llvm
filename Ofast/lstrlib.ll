...
; <label>:25:                                     ; preds = %15, %378
  %26 = phi i32 [ 1, %15 ], [ %380, %378 ]
  %27 = phi i8* [ %10, %15 ], [ %379, %378 ]
...
; <label>:173:                                    ; preds = %148, %148
  ...
  %180 = call fast double @luaL_checknumber(%struct.lua_State* %0, i32 %66) #9
  %181 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* %65, i64 120, i8* nonnull %18, double %180) #9
  br label %373

; <label>:182:                                    ; preds = %148, %148, %148, %148, %148
  %183 = call fast double @luaL_checknumber(%struct.lua_State* %0, i32 %66) #9
  %184 = load i8, i8* %140, align 1, !tbaa !6
  %185 = icmp ne i8 %184, 102
  %186 = call fast double @llvm.fabs.f64(double %183)
  %187 = fcmp fast ult double %186, 1.000000e+100
  %188 = or i1 %185, %187
...
; <label>:310:                                    ; preds = %306
  %311 = call fast double @lua_tonumberx(%struct.lua_State* %0, i32 %66, i32* null) #9
  %312 = fcmp fast oeq double %311, 0x7FF0000000000000
  br i1 %312, label %329, label %313

; <label>:313:                                    ; preds = %310
  %314 = fcmp fast oeq double %311, 0xFFF0000000000000
  br i1 %314, label %329, label %315

; <label>:315:                                    ; preds = %313
  %316 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* %307, i64 120, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.47, i64 0, i64 0), double %311) #9
  %317 = sext i32 %316 to i64
  %318 = call i8* @memchr(i8* %307, i32 46, i64 %317) #11
  %319 = icmp eq i8* %318, null
  br i1 %319, label %320, label %337

; <label>:320:                                    ; preds = %315
  %321 = call %struct.lconv* @localeconv() #9
  %322 = getelementptr inbounds %struct.lconv, %struct.lconv* %321, i64 0, i32 0
  %323 = load i8*, i8** %322, align 8, !tbaa !15
  %324 = load i8, i8* %323, align 1, !tbaa !6
  %325 = sext i8 %324 to i32
  %326 = call i8* @memchr(i8* %307, i32 %325, i64 %317) #11
  %327 = icmp eq i8* %326, null
  br i1 %327, label %337, label %328

; <label>:328:                                    ; preds = %320
  store i8 46, i8* %326, align 1, !tbaa !6
  br label %337

; <label>:329:                                    ; preds = %313, %310
  %330 = phi i8* [ getelementptr inbounds ([7 x i8], [7 x i8]* @.str.44, i64 0, i64 0), %310 ], [ getelementptr inbounds ([8 x i8], [8 x i8]* @.str.45, i64 0, i64 0), %313 ]
  %331 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* %307, i64 120, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.48, i64 0, i64 0), i8* nonnull %330) #9
  br label %337

; <label>:332:                                    ; preds = %306
  %333 = call i64 @lua_tointegerx(%struct.lua_State* %0, i32 %66, i32* null) #9
  %334 = icmp eq i64 %333, -9223372036854775808
  %335 = select i1 %334, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.39, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.40, i64 0, i64 0)
  %336 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* %307, i64 120, i8* %335, i64 %333) #9
  br label %337

; <label>:337:                                    ; preds = %332, %329, %328, %320, %315
  %338 = phi i32 [ %336, %332 ], [ %331, %329 ], [ %316, %328 ], [ %316, %320 ], [ %316, %315 ]
  %339 = sext i32 %338 to i64
  %340 = load i64, i64* %16, align 8, !tbaa !7
  %341 = add i64 %340, %339
  store i64 %341, i64* %16, align 8, !tbaa !7
  br label %373

; <label>:342:                                    ; preds = %209, %209
  %343 = call i8* @luaL_tolstring(%struct.lua_State* %0, i32 %66, i64* null) #9
  call void @luaL_addvalue(%struct.luaL_Buffer* nonnull %5) #9
  br label %373

; <label>:344:                                    ; preds = %209
  %345 = call i32 @luaL_argerror(%struct.lua_State* %0, i32 %66, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.41, i64 0, i64 0)) #9
  br label %373

; <label>:346:                                    ; preds = %148
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %22) #9
  %347 = call i8* @luaL_tolstring(%struct.lua_State* %0, i32 %66, i64* nonnull %7) #9
  %348 = load i8, i8* %21, align 2, !tbaa !6
...
; <label>:351:                                    ; preds = %346
  %352 = load i64, i64* %7, align 8, !tbaa !2
  %353 = call i64 @strlen(i8* %347) #11
  %354 = icmp eq i64 %352, %353
  br i1 %354, label %358, label %355

; <label>:355:                                    ; preds = %351
  %356 = call i32 @luaL_argerror(%struct.lua_State* %0, i32 %66, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.34, i64 0, i64 0)) #9
  %357 = load i64, i64* %7, align 8
  br label %358

; <label>:358:                                    ; preds = %355, %351
  %359 = phi i64 [ %357, %355 ], [ %352, %351 ]
  %360 = call i8* @strchr(i8* nonnull %18, i32 46) #11
  %361 = icmp eq i8* %360, null
  %362 = icmp ugt i64 %359, 99
  %363 = and i1 %361, %362
...
; <label>:365:                                    ; preds = %358
  %366 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* %65, i64 120, i8* nonnull %18, i8* %347) #9
  call void @lua_settop(%struct.lua_State* %0, i32 -2) #9
  br label %367

; <label>:367:                                    ; preds = %364, %365, %350
  %368 = phi i32 [ 0, %350 ], [ 0, %364 ], [ %366, %365 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %22) #9
  br label %373

; <label>:369:                                    ; preds = %148
  %370 = call i32 (%struct.lua_State*, i8*, ...) @luaL_error(%struct.lua_State* %0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.35, i64 0, i64 0), i8* nonnull %18) #9
  br label %371

; <label>:371:                                    ; preds = %68, %369, %207
  %372 = phi i32 [ %208, %207 ], [ %370, %369 ], [ %69, %68 ]
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %18) #9
  br label %383

; <label>:373:                                    ; preds = %156, %160, %173, %191, %201, %367, %301, %337, %342, %344
  %374 = phi i32 [ %368, %367 ], [ %203, %201 ], [ %200, %191 ], [ %181, %173 ], [ %172, %160 ], [ %159, %156 ], [ 0, %301 ], [ 0, %337 ], [ 0, %342 ], [ 0, %344 ]
  %375 = sext i32 %374 to i64
  %376 = load i64, i64* %16, align 8, !tbaa !7
  %377 = add i64 %376, %375
  store i64 %377, i64* %16, align 8, !tbaa !7
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %18) #9
  br label %378

; <label>:378:                                    ; preds = %373, %57, %38
  %379 = phi i8* [ %41, %38 ], [ %60, %57 ], [ %153, %373 ]
  %380 = phi i32 [ %26, %38 ], [ %26, %57 ], [ %66, %373 ]
  %381 = icmp ult i8* %379, %12
  br i1 %381, label %25, label %382

; <label>:382:                                    ; preds = %378, %1
  call void @luaL_pushresult(%struct.luaL_Buffer* nonnull %5) #9
  br label %383

; <label>:383:                                    ; preds = %371, %382
  %384 = phi i32 [ 1, %382 ], [ %372, %371 ]
...
; <label>:319:                                    ; preds = %60
  ...
  %322 = call fast double @luaL_checknumber(%struct.lua_State* %0, i32 %61) #9
