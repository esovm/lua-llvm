...
; <label>:37:                                     ; preds = %30
  %38 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i8* nonnull %2) #9
  br label %39

; <label>:39:                                     ; preds = %30, %37
  %40 = call i32 @lua_checkstack(%struct.lua_State* %0, i32 10) #9
  %41 = icmp eq i32 %40, 0
  br i1 %41, label %42, label %44

; <label>:42:                                     ; preds = %39
  %43 = call i32 (%struct.lua_State*, i8*, ...) @luaL_error(%struct.lua_State* %0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.24, i64 0, i64 0)) #9
  br label %44

; <label>:44:                                     ; preds = %39, %42
  %45 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0)) #9
  %46 = call i32 @lua_getstack(%struct.lua_State* %1, i32 %3, %struct.lua_Debug* nonnull %6) #9
  %47 = icmp eq i32 %46, 0
...
; <label>:62:                                     ; preds = %57
  %63 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #9
  br label %103

; <label>:64:                                     ; preds = %57
  %65 = call i32 @lua_getinfo(%struct.lua_State* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), %struct.lua_Debug* nonnull %6) #9
  %66 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i8* nonnull %50) #9
  %67 = load i32, i32* %51, align 8, !tbaa !2
  %68 = icmp sgt i32 %67, 0
  br i1 %68, label %69, label %71

; <label>:69:                                     ; preds = %64
  %70 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32 %67) #9
  br label %71

; <label>:71:                                     ; preds = %69, %64
  %72 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0)) #9
  %73 = call fastcc i32 @pushglobalfuncname(%struct.lua_State* %0, %struct.lua_Debug* nonnull %6) #9
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %78, label %75

; <label>:75:                                     ; preds = %71
  %76 = call i8* @lua_tolstring(%struct.lua_State* %0, i32 -1, i64* null) #9
  %77 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.47, i64 0, i64 0), i8* %76) #9
...
; <label>:82:                                     ; preds = %78
  ...
  %84 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.48, i64 0, i64 0), i8* %79, i8* %83) #9
  br label %95
...
; <label>:88:                                     ; preds = %85
  %89 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.49, i64 0, i64 0)) #9
  br label %95

; <label>:90:                                     ; preds = %85
  %91 = load i32, i32* %56, align 4, !tbaa !14
  %92 = call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.50, i64 0, i64 0), i8* nonnull %50, i32 %91) #9
  br label %95

; <label>:93:                                     ; preds = %85
  %94 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0)) #9
  br label %95
...
; <label>:98:                                     ; preds = %95
  %99 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i64 0, i64 0)) #9
  br label %100

; <label>:100:                                    ; preds = %95, %98
  %101 = call i32 @lua_gettop(%struct.lua_State* %0) #9
  %102 = sub nsw i32 %101, %8
  call void @lua_concat(%struct.lua_State* %0, i32 %102) #9
  br label %103

; <label>:103:                                    ; preds = %100, %62
  %104 = phi i32 [ %49, %62 ], [ %59, %100 ]
  %105 = add nsw i32 %104, 1
  %106 = call i32 @lua_getstack(%struct.lua_State* %1, i32 %105, %struct.lua_Debug* nonnull %6) #9
  %107 = icmp eq i32 %106, 0
  br i1 %107, label %108, label %57

; <label>:108:                                    ; preds = %103, %44
  %109 = call i32 @lua_gettop(%struct.lua_State* %0) #9
  %110 = sub nsw i32 %109, %8
  call void @lua_concat(%struct.lua_State* %0, i32 %110) #9
...
; <label>:6:                                      ; preds = %4
  %7 = tail call i32 @lua_type(%struct.lua_State* %0, i32 %1) #9
  %8 = icmp slt i32 %7, 1
...
; <label>:11:                                     ; preds = %4
  %12 = tail call i8* @luaL_checklstring(%struct.lua_State* %0, i32 %1, i64* null) #10
  br label %13

; <label>:13:                                     ; preds = %9, %6, %11
  %14 = phi i8* [ %12, %11 ], [ %10, %9 ], [ %2, %6 ]
  %15 = load i8*, i8** %3, align 8, !tbaa !17
...
; <label>:18:                                     ; preds = %17, %23
  %19 = phi i64 [ %24, %23 ], [ 0, %17 ]
  %20 = phi i8* [ %26, %23 ], [ %15, %17 ]
  %21 = tail call i32 @strcmp(i8* nonnull %20, i8* %14) #11
  %22 = icmp eq i32 %21, 0
...
; <label>:28:                                     ; preds = %23, %13
  %29 = tail call i8* (%struct.lua_State*, i8*, ...) @lua_pushfstring(%struct.lua_State* %0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.22, i64 0, i64 0), i8* %14) #9
  %30 = tail call i32 @luaL_argerror(%struct.lua_State* %0, i32 %1, i8* %29) #10
  br label %33
...
; <label>:6:                                      ; preds = %3
  %7 = tail call i8* @lua_typename(%struct.lua_State* %0, i32 4) #9
  %8 = tail call i32 @luaL_typeerror(%struct.lua_State* %0, i32 %1, i8* %7) #9
  br label %9
...
; <label>:6:                                      ; preds = %3
  %7 = tail call i8* @lua_typename(%struct.lua_State* %0, i32 %2) #9
  %8 = tail call i32 @luaL_typeerror(%struct.lua_State* %0, i32 %1, i8* %7) #9
  br label %9
...
; <label>:8:                                      ; preds = %2
  %9 = call i8* @lua_typename(%struct.lua_State* %0, i32 3) #9
  %10 = call i32 @luaL_typeerror(%struct.lua_State* %0, i32 %1, i8* %9) #9
  br label %11
...
; <label>:13:                                     ; preds = %8
  %14 = call i8* @lua_typename(%struct.lua_State* %0, i32 3) #9
  %15 = call i32 @luaL_typeerror(%struct.lua_State* %0, i32 %1, i8* %14) #9
  br label %16
...
; <label>:5:                                      ; preds = %2
  %6 = tail call fastcc i8* @prepbuffsize(%struct.luaL_Buffer* %0, i64 %3, i32 -1) #9
...
define i32 @luaL_loadstring(%struct.lua_State*, i8*) local_unnamed_addr #0 {
  ...
  store i64 %4, i64* %7, align 8, !tbaa !29
  %8 = call i32 @lua_load(%struct.lua_State* %0, i8* (%struct.lua_State*, i8*, i64*)* nonnull @getS, i8* nonnull %5, i8* %1, i8* null) #9
...
; <label>:14:                                     ; preds = %13, %14
  ...
  tail call void @lua_pushvalue(%struct.lua_State* %0, i32 %9) #9
...
; <label>:18:                                     ; preds = %14, %11
  ...
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* %21, i32 %2) #9
  %22 = load i8*, i8** %12, align 8, !tbaa !30
  tail call void @lua_setfield(%struct.lua_State* %0, i32 %10, i8* %22) #9
...
; <label>:26:                                     ; preds = %18, %3
  %27 = xor i32 %2, -1
  tail call void @lua_settop(%struct.lua_State* %0, i32 %27) #9
  ret void
}
...
define void @luaL_addgsub(%struct.luaL_Buffer*, i8*, i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #0 {
  ...
  %6 = tail call i8* @strstr(i8* %1, i8* %2) #11
  %7 = icmp eq i8* %6, null
...
; <label>:17:                                     ; preds = %10
  %18 = tail call fastcc i8* @prepbuffsize(%struct.luaL_Buffer* %0, i64 %15, i32 -1) #9
...
; <label>:21:                                     ; preds = %10, %17
  ...
  %23 = tail call i8* @strstr(i8* %22, i8* %2) #11
  %24 = icmp eq i8* %23, null
  br i1 %24, label %25, label %10

; <label>:25:                                     ; preds = %21, %4
  %26 = phi i8* [ %1, %4 ], [ %22, %21 ]
  tail call void @luaL_addstring(%struct.luaL_Buffer* %0, i8* %26) #10
  ret void
}
...
; <label>:8:                                      ; preds = %5
  tail call void @lua_pushnil(%struct.lua_State* %0) #9
  %9 = tail call i32 @lua_next(%struct.lua_State* %0, i32 -2) #9
  %10 = icmp eq i32 %9, 0
...
; <label>:20:                                     ; preds = %16
  %21 = tail call fastcc i32 @findfield(%struct.lua_State* %0, i32 %1, i32 %12) #10
  %22 = icmp eq i32 %21, 0
...
; <label>:25:                                     ; preds = %20, %13
  tail call void @lua_settop(%struct.lua_State* %0, i32 -2) #9
  %26 = tail call i32 @lua_next(%struct.lua_State* %0, i32 -2) #9
  %27 = icmp eq i32 %26, 0
...
attributes #5 = { nounwind optsize readnone "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #7 = { argmemonly nounwind optsize readonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #8 = { norecurse nounwind optsize uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
