...
define internal i32 @db_debug(%struct.lua_State*) #0 {
  ...
  %5 = call i32 @fputs(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.17, i64 0, i64 0), %struct._IO_FILE* %4) #8
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %7 = call i32 @fflush(%struct._IO_FILE* %6) #9
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !2
  %9 = call i8* @fgets(i8* nonnull %3, i32 250, %struct._IO_FILE* %8) #9
...
; <label>:28:                                     ; preds = %19, %22
  ...
  %30 = call i32 @fputs(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.17, i64 0, i64 0), %struct._IO_FILE* %29) #8
  %31 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %32 = call i32 @fflush(%struct._IO_FILE* %31) #9
  %33 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !2
  %34 = call i8* @fgets(i8* nonnull %3, i32 250, %struct._IO_FILE* %33) #9
...
; <label>:30:                                     ; preds = %27
  ...
  %37 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* nonnull %36) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.32, i64 0, i64 0)) #7
  %38 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 7
  %39 = load i32, i32* %38, align 4, !tbaa !14
  %40 = sext i32 %39 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %40) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.33, i64 0, i64 0)) #7
  %41 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 8
  %42 = load i32, i32* %41, align 8, !tbaa !15
  %43 = sext i32 %42 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %43) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.34, i64 0, i64 0)) #7
  %44 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 3
  %45 = load i8*, i8** %44, align 8, !tbaa !16
  %46 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* %45) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.35, i64 0, i64 0)) #7
  br label %47

; <label>:47:                                     ; preds = %27, %30
  %48 = call i8* @strchr(i8* %22, i32 108) #10
  %49 = icmp eq i8* %48, null
  br i1 %49, label %54, label %50

; <label>:50:                                     ; preds = %47
  %51 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 6
  %52 = load i32, i32* %51, align 8, !tbaa !17
  %53 = sext i32 %52 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %53) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.36, i64 0, i64 0)) #7
  br label %54

; <label>:54:                                     ; preds = %47, %50
  %55 = call i8* @strchr(i8* %22, i32 117) #10
  %56 = icmp eq i8* %55, null
  br i1 %56, label %67, label %57

; <label>:57:                                     ; preds = %54
  %58 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 9
  %59 = load i8, i8* %58, align 4, !tbaa !18
  %60 = zext i8 %59 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %60) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.37, i64 0, i64 0)) #7
  %61 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 10
  %62 = load i8, i8* %61, align 1, !tbaa !19
  %63 = zext i8 %62 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %63) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.38, i64 0, i64 0)) #7
  %64 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 11
  %65 = load i8, i8* %64, align 2, !tbaa !20
  %66 = sext i8 %65 to i32
  call void @lua_pushboolean(%struct.lua_State* %0, i32 %66) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.39, i64 0, i64 0)) #7
  br label %67

; <label>:67:                                     ; preds = %54, %57
  %68 = call i8* @strchr(i8* %22, i32 110) #10
  %69 = icmp eq i8* %68, null
  br i1 %69, label %77, label %70

; <label>:70:                                     ; preds = %67
  %71 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 1
  %72 = load i8*, i8** %71, align 8, !tbaa !21
  %73 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* %72) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.40, i64 0, i64 0)) #7
  %74 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 2
  %75 = load i8*, i8** %74, align 8, !tbaa !22
  %76 = call i8* @lua_pushstring(%struct.lua_State* %0, i8* %75) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.41, i64 0, i64 0)) #7
  br label %77

; <label>:77:                                     ; preds = %67, %70
  %78 = call i8* @strchr(i8* %22, i32 114) #10
  %79 = icmp eq i8* %78, null
  br i1 %79, label %87, label %80

; <label>:80:                                     ; preds = %77
  %81 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 13
  %82 = load i16, i16* %81, align 8, !tbaa !23
  %83 = zext i16 %82 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %83) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.42, i64 0, i64 0)) #7
  %84 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 14
  %85 = load i16, i16* %84, align 2, !tbaa !24
  %86 = zext i16 %85 to i64
  call void @lua_pushinteger(%struct.lua_State* %0, i64 %86) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.43, i64 0, i64 0)) #7
  br label %87

; <label>:87:                                     ; preds = %77, %80
  %88 = call i8* @strchr(i8* %22, i32 116) #10
  %89 = icmp eq i8* %88, null
  br i1 %89, label %94, label %90

; <label>:90:                                     ; preds = %87
  %91 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %2, i64 0, i32 12
  %92 = load i8, i8* %91, align 1, !tbaa !25
  %93 = sext i8 %92 to i32
  call void @lua_pushboolean(%struct.lua_State* %0, i32 %93) #7
  call void @lua_setfield(%struct.lua_State* %0, i32 -2, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.44, i64 0, i64 0)) #7
  br label %94

; <label>:94:                                     ; preds = %87, %90
  %95 = call i8* @strchr(i8* %22, i32 76) #10
...
; <label>:98:                                     ; preds = %94, %97
  %99 = call i8* @strchr(i8* %22, i32 102) #10
...
; <label>:102:                                    ; preds = %101, %98, %25, %20
  %103 = phi i32 [ %26, %25 ], [ 1, %20 ], [ 1, %98 ], [ 1, %101 ]
