...
; <label>:24:                                     ; preds = %1
  ...
  %32 = tail call i8* @lua_pushstring(%struct.lua_State* %0, i8* %31) #7
  br label %47

; <label>:33:                                     ; preds = %1
  %34 = tail call i64 @luaL_optinteger(%struct.lua_State* %0, i32 2, i64 0) #7
  %35 = trunc i64 %34 to i32
  %36 = tail call i64 @luaL_optinteger(%struct.lua_State* %0, i32 3, i64 0) #7
  %37 = trunc i64 %36 to i32
  %38 = tail call i64 @luaL_optinteger(%struct.lua_State* %0, i32 4, i64 0) #7
  %39 = trunc i64 %38 to i32
  %40 = tail call i32 (%struct.lua_State*, i32, ...) @lua_gc(%struct.lua_State* %0, i32 11, i32 %35, i32 %37, i32 %39) #7
  ...
  %43 = tail call i8* @lua_pushstring(%struct.lua_State* %0, i8* %42) #7
  br label %47

; <label>:44:                                     ; preds = %1
  %45 = tail call i32 (%struct.lua_State*, i32, ...) @lua_gc(%struct.lua_State* %0, i32 %5) #7
  %46 = sext i32 %45 to i64
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %46) #7
  br label %47
...
; <label>:7:                                      ; preds = %14, %5
  ...
  %9 = call i8* @luaL_tolstring(%struct.lua_State* %0, i32 %8, i64* nonnull %2) #7
  %10 = icmp ugt i32 %8, 1
...
; <label>:20:                                     ; preds = %14, %1
  ...
  %24 = call i32 @fflush(%struct._IO_FILE* %23) #8
  ret i32 0
}
