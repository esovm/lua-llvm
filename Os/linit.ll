...
; <label>:2:                                      ; preds = %1, %2
  ...
  tail call void @luaL_requiref(%struct.lua_State* %0, i8* %6, i32 (%struct.lua_State*)* nonnull %3, i32 1) #2
  ...
  %9 = load i32 (%struct.lua_State*)*, i32 (%struct.lua_State*)** %8, align 8, !tbaa !7
