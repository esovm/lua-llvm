...
; <label>:5:                                      ; preds = %3
  ...
  %8 = load i64, i64* %6, align 8, !tbaa !10
  br label %9

; <label>:9:                                      ; preds = %5, %24
  %10 = phi i64 [ %8, %5 ], [ %30, %24 ]
  %11 = phi i64 [ %2, %5 ], [ %34, %24 ]
  %12 = phi i8* [ %1, %5 ], [ %33, %24 ]
  %13 = icmp eq i64 %10, 0
  br i1 %13, label %16, label %14

; <label>:14:                                     ; preds = %9
  %15 = load i8*, i8** %7, align 8, !tbaa !11
  br label %24

; <label>:16:                                     ; preds = %9
  %17 = tail call i32 @luaZ_fill(%struct.Zio* nonnull %0) #5
  %18 = icmp eq i32 %17, -1
...
; <label>:19:                                     ; preds = %16
  ...
  %21 = add i64 %20, 1
  store i64 %21, i64* %6, align 8, !tbaa !10
  %22 = load i8*, i8** %7, align 8, !tbaa !11
  %23 = getelementptr inbounds i8, i8* %22, i64 -1
  store i8* %23, i8** %7, align 8, !tbaa !11
  br label %24

; <label>:24:                                     ; preds = %14, %19
  %25 = phi i8* [ %15, %14 ], [ %23, %19 ]
  %26 = phi i64 [ %10, %14 ], [ %21, %19 ]
  %27 = icmp ugt i64 %11, %26
  %28 = select i1 %27, i64 %26, i64 %11
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %25, i64 %28, i32 1, i1 false)
  %29 = load i64, i64* %6, align 8, !tbaa !10
  %30 = sub i64 %29, %28
  store i64 %30, i64* %6, align 8, !tbaa !10
  %31 = load i8*, i8** %7, align 8, !tbaa !11
  %32 = getelementptr inbounds i8, i8* %31, i64 %28
  store i8* %32, i8** %7, align 8, !tbaa !11
  %33 = getelementptr inbounds i8, i8* %12, i64 %28
  %34 = sub i64 %11, %28
  %35 = icmp eq i64 %34, 0
  br i1 %35, label %36, label %9

; <label>:36:                                     ; preds = %24, %16, %3
  %37 = phi i64 [ 0, %3 ], [ %11, %16 ], [ 0, %24 ]
  ret i64 %37
}
