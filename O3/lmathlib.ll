...
define i32 @luaopen_math(%struct.lua_State*) local_unnamed_addr #0 {
  ...
  tail call fastcc void @setseed(i64* %5, i64 %3, i64 %4) #6
...
; <label>:11:                                     ; preds = %5
  ...
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %12) #6
  br label %14

; <label>:13:                                     ; preds = %5
  tail call void @lua_pushnumber(%struct.lua_State* %0, double %7) #6
  br label %14
...
; <label>:14:                                     ; preds = %5
  ...
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %15) #6
  br label %17

; <label>:16:                                     ; preds = %5
  tail call void @lua_pushnumber(%struct.lua_State* %0, double %10) #6
  br label %17
...
; <label>:17:                                     ; preds = %14, %16
  ...
  tail call void @lua_pushnumber(%struct.lua_State* %0, double %20) #6
  br label %21
...
define internal i32 @math_random(%struct.lua_State*) #0 {
  ...
  %28 = tail call i32 @lua_gettop(%struct.lua_State* %0) #6
...
; <label>:29:                                     ; preds = %1
  ...
  tail call void @lua_pushnumber(%struct.lua_State* %0, double %32) #6
  br label %100

; <label>:33:                                     ; preds = %1
  %34 = tail call i64 @luaL_checkinteger(%struct.lua_State* %0, i32 1) #6
  %35 = icmp eq i64 %34, 0
  br i1 %35, label %36, label %42

; <label>:36:                                     ; preds = %33
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %20) #6
  br label %100

; <label>:37:                                     ; preds = %1
  %38 = tail call i64 @luaL_checkinteger(%struct.lua_State* %0, i32 1) #6
  %39 = tail call i64 @luaL_checkinteger(%struct.lua_State* %0, i32 2) #6
  br label %42

; <label>:40:                                     ; preds = %1
  %41 = tail call i32 (%struct.lua_State*, i8*, ...) @luaL_error(%struct.lua_State* %0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.31, i64 0, i64 0)) #6
  br label %100
...
; <label>:46:                                     ; preds = %42
  %47 = tail call i32 @luaL_argerror(%struct.lua_State* %0, i32 1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.32, i64 0, i64 0)) #6
  br label %48
...
; <label>:97:                                     ; preds = %66, %96
  ...
  %99 = add i64 %98, %44
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %99) #6
  br label %100
...
; <label>:5:                                      ; preds = %1
  ...
  tail call fastcc void @setseed(i64* %8, i64 %6, i64 %7) #6
  br label %13

; <label>:9:                                      ; preds = %1
  %10 = tail call i64 @luaL_checkinteger(%struct.lua_State* %0, i32 1) #6
  %11 = tail call i64 @luaL_optinteger(%struct.lua_State* %0, i32 2, i64 0) #6
