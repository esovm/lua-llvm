...
; <label>:11:                                     ; preds = %7
  %12 = tail call i32 @lua_compare(%struct.lua_State* %0, i32 %8, i32 %9, i32 1) #6
  %13 = icmp eq i32 %12, 0
...
; <label>:16:                                     ; preds = %7
  tail call void @lua_pushvalue(%struct.lua_State* %0, i32 %8) #6
  ret i32 1
}
...
; <label>:11:                                     ; preds = %7
  %12 = tail call i32 @lua_compare(%struct.lua_State* %0, i32 %9, i32 %8, i32 1) #6
  %13 = icmp eq i32 %12, 0
  %14 = select i1 %13, i32 %8, i32 %9
  %15 = add nuw nsw i32 %9, 1
  br label %7
...
; <label>:10:                                     ; preds = %7
  %11 = tail call fastcc i64 @nextrand(i64* %0) #7
...
; <label>:45:                                     ; preds = %49, %43
  %46 = phi i64 [ %4, %43 ], [ %50, %49 ]
  %47 = and i64 %46, %44
  %48 = icmp ugt i64 %47, %26
  br i1 %48, label %49, label %51

; <label>:49:                                     ; preds = %45
  %50 = tail call fastcc i64 @nextrand(i64* %3) #6
  br label %45

; <label>:51:                                     ; preds = %45
  %52 = add i64 %47, %21
  tail call void @lua_pushinteger(%struct.lua_State* %0, i64 %52) #6
  br label %53

; <label>:53:                                     ; preds = %51, %17, %13, %6
  %54 = phi i32 [ %18, %17 ], [ 1, %51 ], [ 1, %13 ], [ 1, %6 ]
  ret i32 %54
}
...
; <label>:7:                                      ; preds = %1
  ...
  tail call fastcc void @setseed(i64* %10, i64 %8, i64 %9) #7
  br label %11
