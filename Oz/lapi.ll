...
; <label>:16:                                     ; preds = %13
  %17 = load %struct.TValue*, %struct.TValue** %12, align 8, !tbaa !12
  %18 = load %union.StackValue*, %union.StackValue** %6, align 8, !tbaa !12
  ...
  %26 = load %union.StackValue*, %union.StackValue** %11, align 8, !tbaa !12
  %27 = getelementptr inbounds %union.StackValue, %union.StackValue* %26, i64 1
  store %union.StackValue* %27, %union.StackValue** %11, align 8, !tbaa !12
...
; <label>:13:                                     ; preds = %16, %4
  %14 = load %union.StackValue*, %union.StackValue** %12, align 8, !tbaa !12
  %15 = icmp ult %union.StackValue* %14, %11
  br i1 %15, label %16, label %19

; <label>:16:                                     ; preds = %13
  %17 = getelementptr inbounds %union.StackValue, %union.StackValue* %14, i64 1
  store %union.StackValue* %17, %union.StackValue** %12, align 8, !tbaa !12
...
; <label>:20:                                     ; preds = %2
  ...
  %23 = load %union.StackValue*, %union.StackValue** %22, align 8, !tbaa !12
...
; <label>:26:                                     ; preds = %20, %19
  ...
  %28 = tail call i32 @luaF_close(%struct.lua_State* nonnull %0, %union.StackValue* %27, i32 0) #9
  ret void
}
...
define void @lua_rotate(%struct.lua_State* nocapture readonly, i32, i32) local_unnamed_addr #3 {
  ...
  %7 = tail call fastcc %union.StackValue* @index2stack(%struct.lua_State* %0, i32 %1) #10
  %8 = icmp sgt i32 %2, -1
  %9 = sext i32 %2 to i64
  %10 = sub nsw i64 0, %9
  ...
  tail call fastcc void @reverse(%union.StackValue* %7, %union.StackValue* nonnull %14) #10
  %15 = getelementptr inbounds %union.StackValue, %union.StackValue* %14, i64 1
  tail call fastcc void @reverse(%union.StackValue* nonnull %15, %union.StackValue* nonnull %6) #10
  tail call fastcc void @reverse(%union.StackValue* %7, %union.StackValue* nonnull %6) #10
  ret void
}
...
define i8* @lua_touserdata(%struct.lua_State* nocapture readonly, i32) local_unnamed_addr #5 {
  %3 = tail call fastcc %struct.TValue* @index2value(%struct.lua_State* %0, i32 %1) #10
  %4 = tail call fastcc i8* @touserdata(%struct.TValue* %3) #10
  ret i8* %4
}
...
; <label>:10:                                     ; preds = %2, %2
  %11 = tail call fastcc i8* @touserdata(%struct.TValue* %3) #10
  br label %18
...
; <label>:21:                                     ; preds = %26, %13
  %22 = phi i64 [ %23, %26 ], [ %18, %13 ]
  %23 = add nsw i64 %22, -1
...
; <label>:26:                                     ; preds = %21
  %27 = getelementptr inbounds %struct.CClosure, %struct.CClosure* %14, i64 0, i32 6, i64 %23
  %28 = load %union.StackValue*, %union.StackValue** %16, align 8, !tbaa !12
  %29 = getelementptr inbounds %union.StackValue, %union.StackValue* %28, i64 %23, i32 0
  %30 = bitcast %struct.TValue* %29 to i64*
  %31 = bitcast %struct.TValue* %27 to i64*
  %32 = load i64, i64* %30, align 8
  store i64 %32, i64* %31, align 8
  %33 = getelementptr inbounds %union.StackValue, %union.StackValue* %28, i64 %23, i32 0, i32 1
  %34 = load i8, i8* %33, align 8, !tbaa !15
  %35 = getelementptr inbounds %struct.CClosure, %struct.CClosure* %14, i64 0, i32 6, i64 %23, i32 1
...
define i32 @lua_rawget(%struct.lua_State* nocapture, i32) local_unnamed_addr #0 {
  %3 = tail call fastcc %struct.Table* @gettable(%struct.lua_State* %0, i32 %1) #10
  %4 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6
  %5 = load %union.StackValue*, %union.StackValue** %4, align 8, !tbaa !12
  %6 = getelementptr inbounds %union.StackValue, %union.StackValue* %5, i64 -1, i32 0
  %7 = tail call %struct.TValue* @luaH_get(%struct.Table* %3, %struct.TValue* nonnull %6) #9
  %8 = load %union.StackValue*, %union.StackValue** %4, align 8, !tbaa !12
  %9 = getelementptr inbounds %union.StackValue, %union.StackValue* %8, i64 -1
  store %union.StackValue* %9, %union.StackValue** %4, align 8, !tbaa !12
  %10 = tail call fastcc i32 @finishrawget(%struct.lua_State* %0, %struct.TValue* %7) #10
  ret i32 %10
}
...
define i32 @lua_rawgeti(%struct.lua_State* nocapture, i32, i64) local_unnamed_addr #0 {
  %4 = tail call fastcc %struct.Table* @gettable(%struct.lua_State* %0, i32 %1) #10
  %5 = tail call %struct.TValue* @luaH_getint(%struct.Table* %4, i64 %2) #9
  %6 = tail call fastcc i32 @finishrawget(%struct.lua_State* %0, %struct.TValue* %5) #10
  ret i32 %6
}
...
define i32 @lua_rawgetp(%struct.lua_State* nocapture, i32, i8*) local_unnamed_addr #0 {
  ...
  %6 = tail call fastcc %struct.Table* @gettable(%struct.lua_State* %0, i32 %1) #10
  ...
  %9 = call %struct.TValue* @luaH_get(%struct.Table* %6, %struct.TValue* nonnull %4) #9
  %10 = call fastcc i32 @finishrawget(%struct.lua_State* %0, %struct.TValue* %9) #10
...
define void @lua_rawset(%struct.lua_State*, i32) local_unnamed_addr #0 {
  ...
  %7 = tail call %struct.TValue* @luaH_set(%struct.lua_State* %0, %struct.Table* %3, %struct.TValue* nonnull %6) #9
  %8 = load %union.StackValue*, %union.StackValue** %4, align 8, !tbaa !12
...
; <label>:35:                                     ; preds = %28
  tail call void @luaC_barrierback_(%struct.lua_State* nonnull %0, %struct.GCObject* %23) #9
  %36 = load %union.StackValue*, %union.StackValue** %4, align 8, !tbaa !12
  br label %37
...
; <label>:37:                                     ; preds = %28, %22, %2, %35
  ...
  store %union.StackValue* %39, %union.StackValue** %4, align 8, !tbaa !12
  ret void
}
...
define void @lua_rawseti(%struct.lua_State*, i32, i64) local_unnamed_addr #0 {
  ...
  tail call void @luaH_setint(%struct.lua_State* %0, %struct.Table* %4, i64 %2, %struct.TValue* nonnull %7) #9
...
; <label>:26:                                     ; preds = %19
  tail call void @luaC_barrierback_(%struct.lua_State* nonnull %0, %struct.GCObject* %14) #9
  %27 = load %union.StackValue*, %union.StackValue** %5, align 8, !tbaa !12
  br label %28
...
; <label>:28:                                     ; preds = %19, %13, %3, %26
  ...
  store %union.StackValue* %30, %union.StackValue** %5, align 8, !tbaa !12
  ret void
}
...
define void @lua_rawsetp(%struct.lua_State*, i32, i8*) local_unnamed_addr #0 {
  ...
  %8 = getelementptr inbounds %struct.TValue, %struct.TValue* %4, i64 0, i32 1
  store i8 2, i8* %8, align 8, !tbaa !15
  %9 = call %struct.TValue* @luaH_set(%struct.lua_State* %0, %struct.Table* %6, %struct.TValue* nonnull %4) #9
...
; <label>:37:                                     ; preds = %30
  call void @luaC_barrierback_(%struct.lua_State* nonnull %0, %struct.GCObject* %25) #9
  %38 = load %union.StackValue*, %union.StackValue** %10, align 8, !tbaa !12
  br label %39
...
; <label>:39:                                     ; preds = %30, %24, %3, %37
  ...
  store %union.StackValue* %41, %union.StackValue** %10, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %5) #6
  ret void
}
...
; <label>:66:                                     ; preds = %15
  ...
  store %struct.Table* %17, %struct.Table** %71, align 8, !tbaa !23
  br label %72
...
; <label>:10:                                     ; preds = %6
  %11 = tail call fastcc %union.StackValue* @index2stack(%struct.lua_State* %0, i32 %3) #10
...
; <label>:32:                                     ; preds = %28, %17
  ...
  store i32 %2, i32* %33, align 8, !tbaa !45
  ...
  %37 = sub i64 %27, %36
  %38 = call i32 @luaD_pcall(%struct.lua_State* nonnull %0, void (%struct.lua_State*, i8*)* nonnull @f_call, i8* nonnull %8, i64 %37, i64 %18) #9
  br label %64

; <label>:39:                                     ; preds = %28
  %40 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 8
  %41 = load %struct.CallInfo*, %struct.CallInfo** %40, align 8, !tbaa !2
  %42 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %41, i64 0, i32 4, i32 0, i32 0
  store i32 (%struct.lua_State*, i32, i64)* %5, i32 (%struct.lua_State*, i32, i64)** %42, align 8, !tbaa !22
  %43 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %41, i64 0, i32 4, i32 0, i32 2
  store i64 %4, i64* %43, align 8, !tbaa !22
  ...
  store i32 %48, i32* %49, align 8, !tbaa !22
  ...
  %59 = or i16 %55, %58
  %60 = or i16 %59, 8
  store i16 %60, i16* %53, align 2, !tbaa !47
  tail call void @luaD_call(%struct.lua_State* nonnull %0, %union.StackValue* %24, i32 %2) #9
  %61 = load i16, i16* %53, align 2, !tbaa !47
  %62 = and i16 %61, -9
  store i16 %62, i16* %53, align 2, !tbaa !47
  %63 = load i64, i64* %52, align 8, !tbaa !22
...
; <label>:67:                                     ; preds = %64
  ...
  %69 = load %struct.CallInfo*, %struct.CallInfo** %68, align 8, !tbaa !2
  %70 = getelementptr inbounds %struct.CallInfo, %struct.CallInfo* %69, i64 0, i32 1
  %71 = load %union.StackValue*, %union.StackValue** %70, align 8, !tbaa !14
  %72 = load %union.StackValue*, %union.StackValue** %19, align 8, !tbaa !12
  %73 = icmp ult %union.StackValue* %71, %72
  br i1 %73, label %74, label %75

; <label>:74:                                     ; preds = %67
  store %union.StackValue* %72, %union.StackValue** %70, align 8, !tbaa !14
  br label %75
...
define i32 @lua_next(%struct.lua_State*, i32) local_unnamed_addr #0 {
  ...
  %5 = load %union.StackValue*, %union.StackValue** %4, align 8, !tbaa !12
  %6 = getelementptr inbounds %union.StackValue, %union.StackValue* %5, i64 -1
  %7 = tail call i32 @luaH_next(%struct.lua_State* %0, %struct.Table* %3, %union.StackValue* nonnull %6) #9
  %8 = icmp eq i32 %7, 0
...
define void @lua_toclose(%struct.lua_State*, i32) local_unnamed_addr #0 {
  %3 = tail call fastcc %union.StackValue* @index2stack(%struct.lua_State* %0, i32 %1) #10
  ...
  tail call void @luaF_newtbcupval(%struct.lua_State* %0, %union.StackValue* %3) #9
  %8 = icmp slt i16 %7, -1
...
; <label>:25:                                     ; preds = %11
  %26 = load %struct.GCObject*, %struct.GCObject** %5, align 8, !tbaa !23
...
; <label>:8:                                      ; preds = %3
  %9 = tail call fastcc %struct.UpVal** @getupvalref(%struct.lua_State* %0, i32 %1, i32 %2, %struct.LClosure** null) #10
...
define void @lua_upvaluejoin(%struct.lua_State*, i32, i32, i32, i32) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %7) #6
  %8 = call fastcc %struct.UpVal** @getupvalref(%struct.lua_State* %0, i32 %1, i32 %2, %struct.LClosure** nonnull %6) #10
  %9 = call fastcc %struct.UpVal** @getupvalref(%struct.lua_State* %0, i32 %3, i32 %4, %struct.LClosure** null) #10
...
; <label>:21:                                     ; preds = %16
  ...
  call void @luaC_barrier_(%struct.lua_State* %0, %struct.GCObject* %22, %struct.GCObject* %23) #9
  br label %24
...
attributes #4 = { minsize norecurse nounwind optsize readnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #5 = { minsize norecurse nounwind optsize readonly uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
