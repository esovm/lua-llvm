...
define internal i32 @luaB_coresume(%struct.lua_State*) #0 {
  %2 = tail call fastcc %struct.lua_State* @getco(%struct.lua_State* %0) #4
  %3 = tail call i32 @lua_gettop(%struct.lua_State* %0) #3
  %4 = add nsw i32 %3, -1
  %5 = tail call fastcc i32 @auxresume(%struct.lua_State* %0, %struct.lua_State* %2, i32 %4) #4
  %6 = icmp slt i32 %5, 0
...
define internal i32 @luaB_costatus(%struct.lua_State*) #0 {
  %2 = tail call fastcc %struct.lua_State* @getco(%struct.lua_State* %0) #4
  %3 = tail call fastcc i32 @auxstatus(%struct.lua_State* %0, %struct.lua_State* %2) #4
  %4 = sext i32 %3 to i64
...
define internal i32 @luaB_cowrap(%struct.lua_State*) #0 {
  %2 = tail call i32 @luaB_cocreate(%struct.lua_State* %0) #4
...
; <label>:4:                                      ; preds = %1
  %5 = tail call fastcc %struct.lua_State* @getco(%struct.lua_State* %0) #4
  br label %6
...
; <label>:7:                                      ; preds = %5
  ...
  call void @llvm.lifetime.start.p0i8(i64 136, i8* nonnull %8) #5
...
; <label>:15:                                     ; preds = %11, %7
  ...
  call void @llvm.lifetime.end.p0i8(i64 136, i8* nonnull %8) #5
  br label %18
...
define internal i32 @luaB_auxwrap(%struct.lua_State*) #0 {
  ...
  %3 = tail call i32 @lua_gettop(%struct.lua_State* %0) #3
  %4 = tail call fastcc i32 @auxresume(%struct.lua_State* %0, %struct.lua_State* %2, i32 %3) #4
  %5 = icmp slt i32 %4, 0
