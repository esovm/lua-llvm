...
; <label>:6:                                      ; preds = %3
  ...
  %8 = load %union.StackValue*, %union.StackValue** %7, align 8, !tbaa !37
...
; <label>:12:                                     ; preds = %6
  ...
  %16 = getelementptr inbounds %struct.LClosure, %struct.LClosure* %15, i64 0, i32 5
  %17 = load %struct.Proto*, %struct.Proto** %16, align 8, !tbaa !13
  %18 = tail call i8* @luaF_getlocalname(%struct.Proto* %17, i32 %2, i32 0) #9
  br label %40

; <label>:19:                                     ; preds = %3
  %20 = bitcast %union.StackValue** %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %20) #9
  store %union.StackValue* null, %union.StackValue** %4, align 8, !tbaa !30
  %21 = getelementptr inbounds %struct.lua_Debug, %struct.lua_Debug* %1, i64 0, i32 16
  %22 = load %struct.CallInfo*, %struct.CallInfo** %21, align 8, !tbaa !31
...
; <label>:25:                                     ; preds = %19
  ...
  %30 = load %struct.TValue*, %struct.TValue** %29, align 8, !tbaa !30
  ...
  store i8 %35, i8* %36, align 8, !tbaa !38
  %37 = load %union.StackValue*, %union.StackValue** %26, align 8, !tbaa !37
  %38 = getelementptr inbounds %union.StackValue, %union.StackValue* %37, i64 1
  store %union.StackValue* %38, %union.StackValue** %26, align 8, !tbaa !37
  br label %39
...
define i8* @lua_setlocal(%struct.lua_State* nocapture, %struct.lua_Debug* nocapture readonly, i32) local_unnamed_addr #4 {
  ...
  %7 = load %struct.CallInfo*, %struct.CallInfo** %6, align 8, !tbaa !31
...
; <label>:10:                                     ; preds = %3
  ...
  %12 = load %struct.TValue*, %struct.TValue** %11, align 8, !tbaa !30
  %13 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6
  %14 = load %union.StackValue*, %union.StackValue** %13, align 8, !tbaa !37
  ...
  store i8 %20, i8* %21, align 8, !tbaa !38
  %22 = load %union.StackValue*, %union.StackValue** %13, align 8, !tbaa !37
  %23 = getelementptr inbounds %union.StackValue, %union.StackValue* %22, i64 -1
  store %union.StackValue* %23, %union.StackValue** %13, align 8, !tbaa !37
  br label %24
...
; <label>:79:                                     ; preds = %66
  %80 = lshr i32 %69, 24
  %81 = getelementptr inbounds %struct.Proto, %struct.Proto* %0, i64 0, i32 15
...
; <label>:93:                                     ; preds = %79, %88
  ...
  %95 = lshr i32 %69, 16
  %96 = and i32 %95, 255
  %97 = getelementptr inbounds %struct.Proto, %struct.Proto* %0, i64 0, i32 18
...
; <label>:131:                                    ; preds = %66
  %132 = lshr i32 %69, 24
  %133 = getelementptr inbounds %struct.Proto, %struct.Proto* %0, i64 0, i32 15
...
; <label>:159:                                    ; preds = %66
  %160 = lshr i32 %69, 16
  %161 = and i32 %160, 255
  %162 = getelementptr inbounds %struct.Proto, %struct.Proto* %0, i64 0, i32 18
...
; <label>:200:                                    ; preds = %196
  %201 = getelementptr inbounds %struct.Proto, %struct.Proto* %0, i64 0, i32 15
