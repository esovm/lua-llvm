...
; <label>:28:                                     ; preds = %24
  ...
  %32 = icmp eq i32 %31, 0
  %33 = or i1 %30, %32
  br i1 %33, label %412, label %37

; <label>:34:                                     ; preds = %24
  %35 = and i32 %8, %17
  %36 = icmp eq i32 %35, 0
  br i1 %36, label %412, label %37
...
; <label>:225:                                    ; preds = %291, %217
  %226 = phi i32 [ %209, %217 ], [ %292, %291 ]
  %227 = phi i64 [ %221, %217 ], [ %230, %291 ]
  %228 = icmp ult i64 %227, 4611686018427387904
...
; <label>:234:                                    ; preds = %229
  %235 = load %struct.TValue*, %struct.TValue** %222, align 8, !tbaa !14
  %236 = getelementptr inbounds %struct.TValue, %struct.TValue* %235, i64 %231
  br label %291

; <label>:237:                                    ; preds = %229
  br i1 %86, label %238, label %264
...
; <label>:246:                                    ; preds = %242
  ...
  %259 = icmp ult i64 %231, %258
  br i1 %259, label %260, label %264

; <label>:260:                                    ; preds = %246, %242
  %261 = trunc i64 %230 to i32
  store i32 %261, i32* %2, align 4, !tbaa !8
  %262 = load %struct.TValue*, %struct.TValue** %222, align 8, !tbaa !14
  %263 = getelementptr inbounds %struct.TValue, %struct.TValue* %262, i64 %231
  br label %291

; <label>:264:                                    ; preds = %246, %238, %237
  %265 = load %union.Node*, %union.Node** %223, align 8, !tbaa !13
  %266 = load i8, i8* %224, align 1, !tbaa !15
...
; <label>:272:                                    ; preds = %287, %264
  %273 = phi i32 [ %271, %264 ], [ %289, %287 ]
  %274 = phi %union.Node* [ %265, %264 ], [ %276, %287 ]
  %275 = sext i32 %273 to i64
  %276 = getelementptr inbounds %union.Node, %union.Node* %274, i64 %275
  %277 = getelementptr inbounds %union.Node, %union.Node* %274, i64 %275, i32 0, i32 2
  %278 = load i8, i8* %277, align 1, !tbaa !11
  %279 = icmp eq i8 %278, 35
  br i1 %279, label %280, label %287

; <label>:280:                                    ; preds = %272
  %281 = getelementptr inbounds %union.Node, %union.Node* %274, i64 %275, i32 0, i32 4
  %282 = bitcast %union.Value* %281 to i64*
  %283 = load i64, i64* %282, align 8, !tbaa !11
  %284 = icmp eq i64 %283, %230
  br i1 %284, label %285, label %287

; <label>:285:                                    ; preds = %280
  %286 = bitcast %union.Node* %276 to %struct.TValue*
  br label %291

; <label>:287:                                    ; preds = %280, %272
  %288 = getelementptr inbounds %union.Node, %union.Node* %274, i64 %275, i32 0, i32 3
  %289 = load i32, i32* %288, align 4, !tbaa !11
  %290 = icmp eq i32 %289, 0
  br i1 %290, label %291, label %272

; <label>:291:                                    ; preds = %287, %285, %260, %234
  %292 = phi i32 [ %226, %234 ], [ %261, %260 ], [ %226, %285 ], [ %226, %287 ]
  %293 = phi %struct.TValue* [ %236, %234 ], [ %263, %260 ], [ %286, %285 ], [ @absentkey, %287 ]
  %294 = getelementptr inbounds %struct.TValue, %struct.TValue* %293, i64 0, i32 1
  %295 = load i8, i8* %294, align 8, !tbaa !9
  %296 = and i8 %295, 15
  %297 = icmp eq i8 %296, 0
  br i1 %297, label %329, label %225

; <label>:298:                                    ; preds = %225
  %299 = load %union.Node*, %union.Node** %223, align 8, !tbaa !13
  %300 = load i8, i8* %224, align 1, !tbaa !15
...
; <label>:304:                                    ; preds = %319, %298
  %305 = phi i32 [ %303, %298 ], [ %321, %319 ]
  %306 = phi %union.Node* [ %299, %298 ], [ %308, %319 ]
  %307 = sext i32 %305 to i64
  %308 = getelementptr inbounds %union.Node, %union.Node* %306, i64 %307
  %309 = getelementptr inbounds %union.Node, %union.Node* %306, i64 %307, i32 0, i32 2
  %310 = load i8, i8* %309, align 1, !tbaa !11
  %311 = icmp eq i8 %310, 35
  br i1 %311, label %312, label %319

; <label>:312:                                    ; preds = %304
  %313 = getelementptr inbounds %union.Node, %union.Node* %306, i64 %307, i32 0, i32 4
  %314 = bitcast %union.Value* %313 to i64*
  %315 = load i64, i64* %314, align 8, !tbaa !11
  %316 = icmp eq i64 %315, 9223372036854775807
  br i1 %316, label %317, label %319

; <label>:317:                                    ; preds = %312
  %318 = bitcast %union.Node* %308 to %struct.TValue*
  br label %323

; <label>:319:                                    ; preds = %312, %304
  %320 = getelementptr inbounds %union.Node, %union.Node* %306, i64 %307, i32 0, i32 3
  %321 = load i32, i32* %320, align 4, !tbaa !11
  %322 = icmp eq i32 %321, 0
  br i1 %322, label %323, label %304

; <label>:323:                                    ; preds = %319, %317
  %324 = phi %struct.TValue* [ %318, %317 ], [ @absentkey, %319 ]
  %325 = getelementptr inbounds %struct.TValue, %struct.TValue* %324, i64 0, i32 1
  %326 = load i8, i8* %325, align 8, !tbaa !9
  %327 = and i8 %326, 15
  %328 = icmp eq i8 %327, 0
  br i1 %328, label %329, label %412

; <label>:329:                                    ; preds = %291, %323
  %330 = phi i32 [ %226, %323 ], [ %292, %291 ]
  %331 = phi i64 [ 9223372036854775807, %323 ], [ %230, %291 ]
  %332 = sub i64 %331, %227
...
; <label>:335:                                    ; preds = %334, %401
  %336 = phi i32 [ %402, %401 ], [ %330, %334 ]
  %337 = phi i64 [ %409, %401 ], [ %227, %334 ]
  %338 = phi i64 [ %408, %401 ], [ %331, %334 ]
  %339 = add i64 %338, %337
  %340 = lshr i64 %339, 1
...
; <label>:344:                                    ; preds = %335
  %345 = load %struct.TValue*, %struct.TValue** %222, align 8, !tbaa !14
  %346 = getelementptr inbounds %struct.TValue, %struct.TValue* %345, i64 %341
  br label %401

; <label>:347:                                    ; preds = %335
  br i1 %86, label %348, label %374
...
; <label>:356:                                    ; preds = %352
  ...
  %369 = icmp ult i64 %341, %368
  br i1 %369, label %370, label %374

; <label>:370:                                    ; preds = %356, %352
  %371 = trunc i64 %340 to i32
  store i32 %371, i32* %2, align 4, !tbaa !8
  %372 = load %struct.TValue*, %struct.TValue** %222, align 8, !tbaa !14
  %373 = getelementptr inbounds %struct.TValue, %struct.TValue* %372, i64 %341
  br label %401

; <label>:374:                                    ; preds = %356, %348, %347
  %375 = load %union.Node*, %union.Node** %223, align 8, !tbaa !13
  %376 = load i8, i8* %224, align 1, !tbaa !15
  %377 = zext i8 %376 to i32
  %378 = shl i32 1, %377
  %379 = add nsw i32 %378, -1
  %380 = trunc i64 %340 to i32
  %381 = and i32 %379, %380
  br label %382

; <label>:382:                                    ; preds = %397, %374
  %383 = phi i32 [ %381, %374 ], [ %399, %397 ]
  %384 = phi %union.Node* [ %375, %374 ], [ %386, %397 ]
  %385 = sext i32 %383 to i64
  %386 = getelementptr inbounds %union.Node, %union.Node* %384, i64 %385
  %387 = getelementptr inbounds %union.Node, %union.Node* %384, i64 %385, i32 0, i32 2
  %388 = load i8, i8* %387, align 1, !tbaa !11
  %389 = icmp eq i8 %388, 35
  br i1 %389, label %390, label %397

; <label>:390:                                    ; preds = %382
  %391 = getelementptr inbounds %union.Node, %union.Node* %384, i64 %385, i32 0, i32 4
  %392 = bitcast %union.Value* %391 to i64*
  %393 = load i64, i64* %392, align 8, !tbaa !11
  %394 = icmp eq i64 %393, %340
  br i1 %394, label %395, label %397

; <label>:395:                                    ; preds = %390
  %396 = bitcast %union.Node* %386 to %struct.TValue*
  br label %401

; <label>:397:                                    ; preds = %390, %382
  %398 = getelementptr inbounds %union.Node, %union.Node* %384, i64 %385, i32 0, i32 3
  %399 = load i32, i32* %398, align 4, !tbaa !11
  %400 = icmp eq i32 %399, 0
  br i1 %400, label %401, label %382

; <label>:401:                                    ; preds = %397, %395, %370, %344
  %402 = phi i32 [ %336, %344 ], [ %371, %370 ], [ %336, %395 ], [ %336, %397 ]
  %403 = phi %struct.TValue* [ %346, %344 ], [ %373, %370 ], [ %396, %395 ], [ @absentkey, %397 ]
  %404 = getelementptr inbounds %struct.TValue, %struct.TValue* %403, i64 0, i32 1
  %405 = load i8, i8* %404, align 8, !tbaa !9
  %406 = and i8 %405, 15
  %407 = icmp eq i8 %406, 0
  %408 = select i1 %407, i64 %340, i64 %338
  %409 = select i1 %407, i64 %337, i64 %340
  %410 = sub i64 %408, %409
  %411 = icmp ugt i64 %410, 1
  br i1 %411, label %335, label %412

; <label>:412:                                    ; preds = %401, %329, %323, %91, %34, %37, %28, %215, %137, %81
  %413 = phi i64 [ %82, %81 ], [ %216, %215 ], [ %138, %137 ], [ %9, %28 ], [ %9, %37 ], [ %9, %34 ], [ %94, %91 ], [ 9223372036854775807, %323 ], [ %227, %329 ], [ %409, %401 ]
  ret i64 %413
}
