...
; <label>:7:                                      ; preds = %3
  ...
  %9 = call double @lua_tonumberx(%struct.lua_State* %0, i32 %1, i32* nonnull %4) #4
...
; <label>:16:                                     ; preds = %12, %23
  %17 = phi i8** [ %9, %12 ], [ %28, %23 ]
...
; <label>:23:                                     ; preds = %19, %16
  ...
  %25 = bitcast i8** %24 to i32 (%struct.lua_State*)**
  %26 = load i32 (%struct.lua_State*)*, i32 (%struct.lua_State*)** %25, align 8, !tbaa !35
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* %26, i32 %2) #4
  %27 = load i8*, i8** %17, align 8, !tbaa !33
  tail call void @lua_setfield(%struct.lua_State* %0, i32 %14, i8* %27) #4
...
; <label>:31:                                     ; preds = %23, %8
  %32 = xor i32 %2, -1
  tail call void @lua_settop(%struct.lua_State* %0, i32 %32) #4
  ret void
}
